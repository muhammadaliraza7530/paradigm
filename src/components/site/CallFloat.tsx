...
export function CallFloat() {
  return (
    <a
      ...
      className="animate-wa-shake fixed bottom-6 right-6 z-50 inline-flex size-14 items-center justify-center rounded-full border border-primary bg-primary text-primary-foreground shadow-lg"
    >
